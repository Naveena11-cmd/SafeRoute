...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('incident_type', models.CharField(choices=[('Theft', 'Theft'), ('Harassment', 'Harassment'), ('Lighting', 'Lighting'), ('Construction', 'Construction'), ('Road-block', 'Road-block'), ('Other', 'Other')], max_length=20)),
                ...
                ('source', models.CharField(choices=[('System', 'System'), ('Community', 'Community')], default='Community', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['lat', 'lon'], name='core_incide_lat_959b7f_idx')],
            },
        ),
    ]
